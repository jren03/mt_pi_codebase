...
from models.diffusion.module_attr_mixin import ModuleAttrMixin
from models.diffusion.positional_embedding import SinusoidalPosEmb
    ...
    def forward(
        ...
        **kwargs,
        ...
        if not torch.is_tensor(timesteps):
            # NOTE: this requires sync between CPU and GPU. So try to pass timesteps as tensors if you can
